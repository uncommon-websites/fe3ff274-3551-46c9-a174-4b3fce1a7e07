...
<nav
	class="sticky top-0 left-0 z-50 w-full bg-white/80 backdrop-blur transition duration-150 ease-out dark:bg-gray-950/80"
...
>
	<div class="px container mx-auto flex items-center justify-between py-2.5">
		...
		{#if isMenuOpen}
			<div
				class="fixed inset-0 z-50 flex flex-col bg-white md:hidden dark:bg-gray-900"
