...
<div class="container mx-auto section-px section-py">
	<!-- Theme Controls -->
	<div class="fixed top-4 right-4 z-50">
		...
		{#if showControls}
			<div class="absolute top-12 right-0 w-80 bg-card border border-border rounded-lg p-4 shadow-lg space-y-4">
				...
				<div class="space-y-2">
					...
					<select bind:value={backgroundShade} class="w-full p-2 border border-border rounded bg-background text-foreground">
				...
				<Button 
					variant="ghost" 
					size="sm" 
					onclick={() => { themeRadius = 8; primaryHue = 155; backgroundShade = 50; }}
					class="w-full"
				>
					Reset to Defaults
				</Button>
	...
	<div class="space-y-16">
		...
		<section class="space-y-8">
			...
			<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6">
				<Card 
					title="Basic Card"
					description="This is a basic card component with some content."
				/>

				<Card 
					title="Card with Icon"
					description="A card that contains an icon."
					icon={IconZap}
				/>
		...
		<section class="space-y-8">
			...
			<div class="space-y-4">
				...
				<div>
					<p class="text-body">Body text - Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
		...
		<section class="space-y-8">
			...
			<div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
				...
				<div class="p-4 rounded border" style="background-color: var(--color-foreground); color: var(--color-background); border-color: var(--color-border);">
					<div class="text-caption font-medium">Foreground</div>
					<div class="text-footnote">--color-foreground</div>
				</div>
				
				<div class="p-4 rounded border" style="background-color: var(--color-primary); color: var(--color-primary-foreground); border-color: var(--color-border);">
					<div class="text-caption font-medium">Primary</div>
					<div class="text-footnote">--color-primary</div>
				</div>
				
				<div class="p-4 rounded border" style="background-color: var(--color-secondary); color: var(--color-secondary-foreground); border-color: var(--color-border);">
					<div class="text-caption font-medium">Secondary</div>
					<div class="text-footnote">--color-secondary</div>
				</div>
				
				<div class="p-4 rounded border" style="background-color: var(--color-muted); color: var(--color-muted-foreground); border-color: var(--color-border);">
					<div class="text-caption font-medium">Muted</div>
					<div class="text-footnote">--color-muted</div>
				</div>
				
				<div class="p-4 rounded border" style="background-color: var(--color-accent); color: var(--color-accent-foreground); border-color: var(--color-border);">
					<div class="text-caption font-medium">Accent</div>
					<div class="text-footnote">--color-accent</div>
				</div>
				
				<div class="p-4 rounded border" style="background-color: var(--color-card); color: var(--color-card-foreground); border-color: var(--color-border);">
					<div class="text-caption font-medium">Card</div>
					<div class="text-footnote">--color-card</div>
				</div>
				
				<div class="p-4 rounded border" style="background-color: var(--color-popover); color: var(--color-popover-foreground); border-color: var(--color-border);">
		...
		<section class="space-y-8">
			...
			<div class="grid grid-cols-2 md:grid-cols-4 gap-4">
				<div class="p-4 bg-gray-100" style="border-radius: var(--radius-xs); background-color: var(--color-muted);">
					<div class="text-caption font-medium">XS</div>
					<div class="text-footnote">--radius-xs</div>
				</div>
				
				<div class="p-4 bg-gray-100" style="border-radius: var(--radius-sm); background-color: var(--color-muted);">
					<div class="text-caption font-medium">SM</div>
					<div class="text-footnote">--radius-sm</div>
				</div>
				
				<div class="p-4 bg-gray-100" style="border-radius: var(--radius); background-color: var(--color-muted);">
					<div class="text-caption font-medium">Default</div>
					<div class="text-footnote">--radius</div>
				</div>
				
				<div class="p-4 bg-gray-100" style="border-radius: var(--radius-lg); background-color: var(--color-muted);">
			...
			features={[
				{
					...
					icon: IconZap,
					imageSrc: "https://images.unsplash.com/photo-1677442136019-21780ecad995?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80"
				}
			]}
		/>
		...
		<Features 
			...
			features={[
				...
				},
				{
					...
					imageSrc: "https://images.unsplash.com/photo-1451187580459-43490279c0fa?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80"
				}
			]}
		/>
			...
			features={[
				{
					...
					icon: IconZap,
					imageSrc: "https://images.unsplash.com/photo-1451187580459-43490279c0fa?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=600&q=80"
				},
				{
				...
				},
				{
					...
					imageSrc: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=600&q=80"
				}
			]}
		/>
		...
		<Features 
			...
			features={[
				...
				},
				{
					...
					imageSrc: "https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=600&q=80"
				},
				{
					title: "24/7 support",
		...
		<Features 
			...
			features={[
				...
				},
				{
					...
					imageSrc: "https://images.unsplash.com/photo-1517077304055-6e89abbf09b0?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=600&q=80"
				},
				{
				...
				},
				{
					...
					icon: IconZap,
					imageSrc: "https://images.unsplash.com/photo-1677442136019-21780ecad995?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=600&q=80"
				},
				{
